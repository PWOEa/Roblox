...
do
    ...
    menu = library.new([[memesense  <font color="rgb(78, 93, 234)">| beta
</font>]], "nemv2\\")
    local tabs = {
    ...
    setclipboard("dingle<<#6027")
    game.StarterGui:SetCore("SendNotification", {
            Title = "memesense";
            Text = "get good get memesense private cheat <3!";
    ...
    do
        ...
        viewoffset.element("Slider", "z offset", {default = {min = -30, max = 10, default = 0}})
